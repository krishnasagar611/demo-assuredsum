  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const response = await axios.post(
        "https://api-dev.assuredsum.com/api/v1/getMyForm26",
        { userName, password },
        {
          headers: {
        ...
        <div className="flex flex-col items-center justify-center border-gray-300 rounded-lg p-6">
          ...
          <Dialog open={isOpen} onOpenChange={setIsOpen}>
            ...
            <DialogContent className="sm:max-w-[425px]">
              <DialogHeader>
                <DialogTitle>Enter 26AS Credentials</DialogTitle>
                <DialogDescription>
                  Please provide your username and password to retrieve your
                  26AS data.
                </DialogDescription>
              </DialogHeader>
              <form onSubmit={handleSubmit}>
                ...
                <DialogFooter>
                  ...
                  type="submit" disabled={isLoading}>
                    {isLoading ? "Retrieving..." : "Get My 26AS"}
                  </Button>
                </DialogFooter>
              </form>
            </DialogContent>
...
export default Form26ASretrive;
